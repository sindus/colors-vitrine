...
function ProductDetail({
  ...
  return (
    <>
      ...
      {/* Main grid */}
      <div
        className="mx-auto w-full max-w-[1440px] px-[22px] pb-[100px] lg:px-10"
        style={{
          display: "grid",
      ...
      >
        <div
          className="grid grid-cols-1 gap-10 lg:gap-10"
          style={{
            gridTemplateColumns: "1fr",
          }}
        >
...
function ProductInfo({
  ...
  return (
    <>
      ...
      >
        <span className="font-sans text-[28px] font-normal text-forest">
          {product.price}€
        </span>
      ...
      <div className="mb-9">
        <div className="mb-3 flex items-center justify-between">
          ...
          <a
            href="#"
            className="font-sans text-[11px] text-muted underline hover:text-forest"
          >
            Guide des tailles ↗
          </a>
        </div>
          ...
          {product.sizes.map((size) => (
            <button
              ...
              style={{
                ...
                backgroundColor:
                  selectedSize === size ? "#1d5236" : "transparent",
      ...
      >
        ...
        <p className="mt-3 font-sans text-[13px] font-light leading-[1.6] text-muted-strong">
          On vous répond dans la journée pour la mettre de côté en boutique et
          fixer un créneau d&apos;essayage.
        </p>
        <a
          ...
          <div key={i} style={{ borderTop: "1px solid #cdbfa3" }}>
            ...
            >
              ...
              <span
                ...
                style={{
                  transform:
                    openAccordion === i ? "rotate(45deg)" : "rotate(0deg)",
                }}
              >
                +
              </span>
